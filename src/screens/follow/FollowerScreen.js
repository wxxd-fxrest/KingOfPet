...
const FollowerScreen = ({ navigation }) => {
    ...
    return (
        <Container>
            {currentUserData.follower_data && currentUserData.follower_data.length === 0 ? (
                <NoneBox>
                    <None>아직 팔로워가 없습니다.</None>
                </NoneBox>
            ) : (
                <>
                    {currentUserData.follower_data && currentUserData.follower_data.length < 1 ? (
                        <LoadingContainer>
